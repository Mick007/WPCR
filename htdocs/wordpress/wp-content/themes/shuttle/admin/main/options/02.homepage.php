...
$shuttle_homepage_section4_link  = shuttle_var ( 'shuttle_homepage_section4_link' );
	...
	$shuttle_homepage_section1_desc = __( 'To begin customizing your site go to Appearance &#45;&#62; Customizer and select Theme Options. Here&#39;s you&#39;ll find custom options to help build your site.', 'shuttle' );

	if ( empty( $shuttle_homepage_section2_desc ) ) 
	$shuttle_homepage_section2_desc = __( 'To add a slider go to Theme Options &#45;&#62; Homepage and choose page slider. The slider will use the page title, excerpt and featured image for the slides.', 'shuttle' );

	if ( empty( $shuttle_homepage_section3_desc ) ) 
	$shuttle_homepage_section3_desc = __( 'To add featured content go to Theme Options &#45;&#62; Homepage (Featured) and turn the switch on then add the content you want for each section.', 'shuttle' );
