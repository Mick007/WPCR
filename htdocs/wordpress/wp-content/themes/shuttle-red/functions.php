...
function shuttle_child_frontscripts() {
	...
	wp_enqueue_style( 'shuttle-style-ebusiness', get_stylesheet_directory_uri() . '/style.css', array( 'shuttle-style' ), wp_get_theme()->get('Version') );
}
...
function shuttle_updateoption_child_settings() {
	...
	$name_child_color   = $name_theme_lower . '_child_color_red';
